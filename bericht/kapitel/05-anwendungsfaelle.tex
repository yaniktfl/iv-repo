...
Ein markanter Einzelfall lässt sich an der Zelle mit dem höchsten Erneuerbarenanteil des Jahres ablesen: Am 1.\ Mai 2024 um 12:00 Uhr erreichte der Anteil $138{,}6\,\%$ bei einem Börsenpreis von $-120{,}07$\,EUR/MWh. Zu dieser Stunde stand einer Gesamtlast von $43{,}0$\,GW eine solare Einspeisung von $43{,}5$\,GW, eine Winderzeugung von $9{,}8$\,GW sowie ein Nettoexport von $-12{,}1$\,GW gegenüber. Die Solarleistung allein übertraf somit den inländischen Bedarf. Ein Klick auf diese Zelle ruft das Profil des gesamten Tages im Detailpanel auf (Abbildung~\ref{fig:anwendungsfall-mai}). Hierbei wird ersichtlich, dass es sich nicht um eine isolierte Extremstunde handelt: Der 1.\ Mai verzeichnete insgesamt 8 negative Preisstunden bei einer durchschnittlichen Tagesdeckung von $94{,}8\,\%$.
...
Die interaktive Filterung mittels Brushing ermöglicht das Auffinden weiterer Systemmuster. Wird beispielsweise auf der Achse der negativen Preisstunden der obere Wertebereich selektiert, isoliert die Anwendung wenige Tage mit extremer Häufung. An der Spitze steht der 7.\ Juli 2024 mit 16 negativen Preisstunden bei einem Erneuerbarenanteil von $74{,}5\,\%$ ($32{,}5\,\%$ Solar- und $25{,}4\,\%$ Windanteil). Die verbleibenden Linienbündel weisen ein einheitliches Muster auf: Sie erreichen auf der Solarachse ausnahmslos hohe Werte, streuen auf der Gesamtachse jedoch über einen weiten Bereich. Dies bestätigt die Erkenntnis aus der Heatmap in einer unabhängigen Darstellung.

In tabellarischer Form ließe sich der direkte Vergleich zweier bekannter Tage zwar numerisch exakt durchführen, die parallelen Koordinaten bieten jedoch zwei wesentliche Mehrwerte: Sie verorten die beiden Tage unmittelbar im Kontext der Gesamtdarstellung als Randpunkte der Verteilung, und sie erlauben das Auffinden relevanter Tage ohne vorherige Kenntnis konkreter Datumsangaben. Eine manuelle Filterung in einer Tabelle über 364 Zeilen und sieben Spalten wäre zwar rechnerisch möglich, böte jedoch keine Rückmeldung über die relative Lage der Treffermenge im multiattributiven Raum. Eine lineare Dimensionsreduktion wie die Hauptkomponentenanalyse (PCA) würde die extremen Tage zwar ebenfalls als distanzierte Punkte abbilden, ließe jedoch keine unmittelbare Rückführung auf die treibende physikalische Einzeldimension zu.
